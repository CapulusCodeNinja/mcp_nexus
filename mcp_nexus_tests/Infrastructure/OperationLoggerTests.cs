...
namespace mcp_nexus_tests.Services
{
    public class OperationLoggerTests
    {
        ...
        {
            // Assert
            Assert.Equal("Install", OperationLogger.OperationTypes.Install);
            Assert.Equal("Uninstall", OperationLogger.OperationTypes.Uninstall);
            Assert.Equal("ForceUninstall", OperationLogger.OperationTypes.ForceUninstall);
            Assert.Equal("Update", OperationLogger.OperationTypes.Update);
            Assert.Equal("Build", OperationLogger.OperationTypes.Build);
            Assert.Equal("Copy", OperationLogger.OperationTypes.Copy);
            Assert.Equal("Registry", OperationLogger.OperationTypes.Registry);
            Assert.Equal("Service", OperationLogger.OperationTypes.Service);
            Assert.Equal("Cleanup", OperationLogger.OperationTypes.Cleanup);
            Assert.Equal("HTTP", OperationLogger.OperationTypes.Http);
            Assert.Equal("Stdio", OperationLogger.OperationTypes.Stdio);
            Assert.Equal("MCP", OperationLogger.OperationTypes.Mcp);
            Assert.Equal("Tool", OperationLogger.OperationTypes.Tool);
            Assert.Equal("Protocol", OperationLogger.OperationTypes.Protocol);
            Assert.Equal("Debug", OperationLogger.OperationTypes.Debug);
            Assert.Equal("Startup", OperationLogger.OperationTypes.Startup);
            Assert.Equal("Shutdown", OperationLogger.OperationTypes.Shutdown);
        }
