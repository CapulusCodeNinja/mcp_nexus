...
namespace mcp_nexus_tests.Tools
{
    public class SessionManagementCommandsTests
    {
        ...
        public SessionManagementCommandsTests()
        {
        ...
        [Fact]
        public async Task ListSessions_WithValidSessions_ReturnsSessionsList()
        {
            // Arrange
        ...
        [Fact]
        public async Task ListCommands_WithValidSession_ReturnsCommandsList()
        {
            // Arrange
        ...
        [Fact]
        public async Task ListCommands_WithInvalidSession_ReturnsError()
        {
            // Arrange
        ...
        [Fact]
        public async Task ListSessions_WithException_ReturnsError()
        {
            // Arrange
