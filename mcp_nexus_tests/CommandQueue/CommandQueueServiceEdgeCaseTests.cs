...
namespace mcp_nexus_tests.CommandQueue
{
    ...
    public class CommandQueueServiceEdgeCaseTests : IDisposable
    {
        ...
        {
            // Arrange
            m_mockCdbSession.Setup(x => x.IsActive).Throws(new InvalidOperationException("CDB session error"));

            // Act
            var service = new CommandQueueService(m_mockCdbSession.Object, m_mockLogger.Object, m_mockLoggerFactory.Object);
