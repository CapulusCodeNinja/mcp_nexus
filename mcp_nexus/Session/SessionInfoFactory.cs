...
namespace mcp_nexus.Session
{
    ...
    /// </summary>
    public class SessionInfoFactory : ISessionInfoFactory
    {
        /// <summary>
        ...
        public ISessionInfo CreateSessionInfo(string sessionId, ICdbSession cdbSession, ICommandQueueService commandQueue, 
        ...
        public ISessionInfo CreateDefaultSessionInfo()
        {
