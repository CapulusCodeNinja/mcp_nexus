namespace mcp_nexus.Health
{
    ...
    /// </summary>
    public class AdvancedHealthStatusBuilder : IAdvancedHealthStatusBuilder
    {
        private readonly IAdvancedHealthStatus m_healthStatus;
        ...
        public IAdvancedHealthStatusBuilder SetHealthStatus(bool isHealthy, string message)
        {
        ...
        /// <returns>Builder instance for method chaining</returns>
        public IAdvancedHealthStatusBuilder WithMemoryUsage(IMemoryHealth? memoryHealth)
        {
        ...
        /// <returns>Builder instance for method chaining</returns>
        public IAdvancedHealthStatusBuilder WithCpuUsage(ICpuHealth? cpuHealth)
        {
        ...
        /// <returns>Builder instance for method chaining</returns>
        public IAdvancedHealthStatusBuilder WithDiskUsage(IDiskHealth? diskHealth)
        {
        ...
        /// <returns>Builder instance for method chaining</returns>
        public IAdvancedHealthStatusBuilder WithThreadCount(IThreadHealth? threadHealth)
        {
        ...
        /// <returns>Builder instance for method chaining</returns>
        public IAdvancedHealthStatusBuilder WithGcStatus(IGcHealth? gcHealth)
        {
        ...
        public IAdvancedHealthStatus Build()
        {
