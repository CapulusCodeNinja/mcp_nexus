...
public class ProtocolToolsTests
{
    ...
    {
        // Act
        var result = await EnqueueAsyncDumpAnalyzeCommandTool.winaidbg_enqueue_async_dump_analyze_command(string.Empty, "test command");
    ...
    {
        // Act
        var result = await EnqueueAsyncDumpAnalyzeCommandTool.winaidbg_enqueue_async_dump_analyze_command("session-123", string.Empty);
    ...
    {
        // Act
        var result = await EnqueueAsyncDumpAnalyzeCommandTool.winaidbg_enqueue_async_dump_analyze_command("   ", "test command");
    ...
    {
        // Act
        var result = await EnqueueAsyncDumpAnalyzeCommandTool.winaidbg_enqueue_async_dump_analyze_command("session-123", "   ");
    ...
    {
        // Act
        var result = await EnqueueAsyncDumpAnalyzeCommandTool.winaidbg_enqueue_async_dump_analyze_command("invalid-session-999", "test command");
    ...
    {
        // Act
        var result = await EnqueueAsyncExtensionCommandTool.winaidbg_enqueue_async_extension_command(string.Empty, "testExtension", null);
    ...
    {
        // Act
        var result = await EnqueueAsyncExtensionCommandTool.winaidbg_enqueue_async_extension_command("session-123", string.Empty, null);
    ...
    {
        // Act
        var result = await EnqueueAsyncExtensionCommandTool.winaidbg_enqueue_async_extension_command("   ", "testExtension", null);
    ...
    {
        // Act
        var result = await EnqueueAsyncExtensionCommandTool.winaidbg_enqueue_async_extension_command("session-123", "   ", null);
    ...
    {
        // Act
        var result = await EnqueueAsyncExtensionCommandTool.winaidbg_enqueue_async_extension_command("invalid-session-999", "testExtension", null);
    ...
    public async Task EnqueueExtensionCommand_WithParameters_HandlesGracefully()
    {
        ...
        var result = await EnqueueAsyncExtensionCommandTool.winaidbg_enqueue_async_extension_command("invalid-session-999", "testExtension", parameters);
    ...
    {
        // Act
        var result = await GetDumpAnalyzeCommandsStatusTool.winaidbg_get_dump_analyze_commands_status("invalid-session-999");
    ...
    {
        // Act
        var result = await GetDumpAnalyzeCommandsStatusTool.winaidbg_get_dump_analyze_commands_status(string.Empty);
    ...
    {
        // Act
        var result = await GetDumpAnalyzeCommandsStatusTool.winaidbg_get_dump_analyze_commands_status("test-session");
