...
public class CdbSessionTests
{
    ...
    private WinAiDbg.Engine.Preprocessing.CommandPreprocessor CreatePreprocessor()
    {
    ...
    {
        // Arrange
        var tempRoot = Path.Combine(Path.GetTempPath(), "WinAiDbgCdbRetentionTests", Guid.NewGuid().ToString("N"));
