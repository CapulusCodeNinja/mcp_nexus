...
public class BatchCommandBuilderTests
{
    ...
    public void BuildBatch_WithMultipleCommands_AddsSentinelMarkers()
    {
        ...
        _ = result.CommandText.Should().Contain("winaidbg_COMMAND_SEPARATOR_cmd-1_START");
        _ = result.CommandText.Should().Contain("winaidbg_COMMAND_SEPARATOR_cmd-1_END");
        _ = result.CommandText.Should().Contain("winaidbg_COMMAND_SEPARATOR_cmd-2_START");
        _ = result.CommandText.Should().Contain("winaidbg_COMMAND_SEPARATOR_cmd-2_END");
    }
    ...
    public void BuildBatch_WithThreeCommands_CreatesBatchWithAllThree()
    {
        ...
        _ = result.CommandId.Should().StartWith("cmd-test-session-");
        _ = result.CommandText.Should().Contain("winaidbg_COMMAND_SEPARATOR_cmd-1");
        _ = result.CommandText.Should().Contain("winaidbg_COMMAND_SEPARATOR_cmd-2");
        _ = result.CommandText.Should().Contain("winaidbg_COMMAND_SEPARATOR_cmd-3");
    }
}
