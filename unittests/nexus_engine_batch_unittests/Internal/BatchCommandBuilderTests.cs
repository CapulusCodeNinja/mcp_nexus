...
public class BatchCommandBuilderTests
{
    ...
    {
        var action = () => m_Builder.BuildBatch(null!);
    ...
    {
        var action = () => m_Builder.BuildBatch(new List<Command>());
    ...
    public void BuildBatch_WithSingleCommand_ReturnsSameCommand()
    {
        ...
        var result = m_Builder.BuildBatch(new List<Command> { command });
    ...
    public void BuildBatch_WithMultipleCommands_CreatesBatchId()
    {
        ...
        _ = result.CommandId.Should().Be("batch_cmd-1_cmd-2");
    }
    ...
    public void BuildBatch_WithThreeCommands_CreatesBatchWithAllThree()
    {
        ...
        _ = result.CommandId.Should().Be("batch_cmd-1_cmd-2_cmd-3");
