...
public class DebugSessionTests : IDisposable
{
    ...
    public void Constructor_WithNullSessionId_ThrowsArgumentNullException()
    {
        ...
        _ = Assert.Throws<ArgumentNullException>(() =>
            new DebugSession(null!, TestDumpFilePath, TestSymbolPath, m_MockFileSystem.Object, m_MockProcessManager.Object));
    }
    ...
    public void Constructor_WithNullDumpFilePath_ThrowsArgumentNullException()
    {
        // Act & Assert
        _ = Assert.Throws<ArgumentNullException>(() =>
            new DebugSession(TestSessionId, null!, TestSymbolPath, m_MockFileSystem.Object, m_MockProcessManager.Object));
    }
    ...
    {
        // Act
        using var session = new DebugSession(TestSessionId, TestDumpFilePath, TestSymbolPath, m_MockFileSystem.Object, m_MockProcessManager.Object);
    ...
    {
        // Act
        using var session = new DebugSession(TestSessionId, TestDumpFilePath, null, m_MockFileSystem.Object, m_MockProcessManager.Object);
    ...
    {
        // Arrange
        var session = new DebugSession(TestSessionId, TestDumpFilePath, TestSymbolPath, m_MockFileSystem.Object, m_MockProcessManager.Object);
