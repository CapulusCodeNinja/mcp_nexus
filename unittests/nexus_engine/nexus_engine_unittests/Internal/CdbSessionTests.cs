...
public class CdbSessionTests
{
    ...
    {
        // Act & Assert
        var act = () => new CdbSession(null!, m_MockProcessManager.Object);
    ...
    {
        // Act & Assert
        var act = () => new CdbSession(m_MockFileSystem.Object, null!);
    ...
    {
        // Act
        var session = new CdbSession(m_MockFileSystem.Object, m_MockProcessManager.Object);
    ...
    public async Task InitializeAsync_NullDumpFilePath_ThrowsArgumentException()
    {
        ...
        // Act
        var act = async () => await session.InitializeAsync(null!, null);
    ...
    public async Task InitializeAsync_EmptyDumpFilePath_ThrowsArgumentException()
    {
        ...
        // Act
        var act = async () => await session.InitializeAsync(string.Empty, null);
    ...
    public async Task InitializeAsync_WhitespaceDumpFilePath_ThrowsArgumentException()
    {
        ...
        // Act
        var act = async () => await session.InitializeAsync("   ", null);
    ...
    public async Task InitializeAsync_DumpFileDoesNotExist_ThrowsFileNotFoundException()
    {
        ...
        // Act
        var act = async () => await session.InitializeAsync(dumpPath, null);
    ...
    public async Task InitializeAsync_DisposedSession_ThrowsObjectDisposedException()
    {
        ...
        // Act
        var act = async () => await session.InitializeAsync(@"C:\test\dump.dmp", null);
