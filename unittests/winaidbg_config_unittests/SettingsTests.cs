...
namespace WinAiDbg.Config_unittests;
...
public class SettingsTests : IDisposable
{
    ...
    public void Get_AfterConstructor_ReturnsConfiguration()
    {
        ...
        _ = config.Should().BeOfType<WinAiDbg.Config.Models.SharedConfiguration>();
    }
    ...
    public async Task Get_WithConcurrentAccess_IsThreadSafe()
    {
        ...
        var tasks = new Task<WinAiDbg.Config.Models.SharedConfiguration>[threadCount];
    ...
    public async Task Get_WithRaceCondition_HandlesCorrectly()
    {
        ...
        var tasks = new List<Task<WinAiDbg.Config.Models.SharedConfiguration>>();
        for (var i = 0; i < 20; i++)
        {
